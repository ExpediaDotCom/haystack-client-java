...
public class HaystackHttpServiceParserTest {
    ...
    public void testErrorWithException() {
        ...
        CustomSpanCustomizer customizer = new CustomSpanCustomizer();
        haystackHttpClientParser.error(400, new Exception("Test it"), customizer);

        assertThat(customizer.tags.get("error")).isEqualTo("true");
        assertThat(customizer.tags.get("errorMessage")).isEqualTo("Test it");
    }
