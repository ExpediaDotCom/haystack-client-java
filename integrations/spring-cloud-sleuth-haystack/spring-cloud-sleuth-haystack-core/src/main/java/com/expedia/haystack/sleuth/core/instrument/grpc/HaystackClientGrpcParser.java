...
public class HaystackClientGrpcParser extends GrpcClientParser {

    @Override
    protected <ReqT, RespT> void onStart(MethodDescriptor<ReqT, RespT> method, CallOptions options, Metadata headers, SpanCustomizer span) {
        String spanName = spanName(method);
